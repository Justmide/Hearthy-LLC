        ...
        <div className="xs:col-span-2 md:col-span-1">
          ...
          <div className="text-xs sm:text-sm opacity-90 leading-relaxed space-y-1.5 sm:space-y-2">
            <div className="flex items-start">
              ...
              <a href="mailto:info@hearthyconsulting.com" className="hover:text-primary transition-colors break-all">Info@hearthyconsulting.com</a>
            </div>
            <div className="flex items-start">
              <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <a href="tel:+1234567890" className="hover:text-primary transition-colors whitespace-nowrap">(123) 456-7890</a>
            </div>
            <div className="flex items-start">
              <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <address className="not-italic">
                123 Business Ave, Suite 100<br />City, State 12345<br />United States
              </address>
            </div>
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 mb-3 sm:mb-5">
            ...
            {[
              ...
              <a key={i} href="#" aria-label={`${icon.name} link`} className="hover:scale-110 transition-transform duration-300">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#3A6351" className="w-4 h-4 sm:w-5 sm:h-5">
                  <path d={icon.d} />
                </svg>
              </a>
            ))}
