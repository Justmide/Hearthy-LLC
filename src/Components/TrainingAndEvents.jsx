        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center"
          ...
          <div className="pt-4 flex flex-col lg:justify-normal lg:items-start items-center justify-center text-white"
            ...
            <div className="text-[15px] text-white font-medium italic pt-4 lg:text-justify text-center"
              ...
              <ul className="flex-col flex pt-4 space-y-2"
                data-aos="fade-down">
                <li className="rounded px-2 py-1 inline-block">✅ Behavior Intervention Techniques</li>
                <li className=" rounded px-2 py-1 inline-block">✅ Inclusive Classroom Strategies</li>
                <li className="rounded px-2 py-1 inline-block">✅ IEP & Communication Tools</li>
                <li className="rounded px-2 py-1 inline-block">✅ Virtual & In-Person Options</li>
              </ul>
              <p className="pt-4"
                data-aos="fade-down">
...
<br />
<span className="rounded px-2 py-1 inline-block">✅ <strong>Cruise Adventures</strong></span> <br />
<span className="rounded px-2 py-1 inline-block">✅ <strong>Milestone Celebrations</strong></span> <br />
<span className=" rounded px-2 py-1 inline-block">✅ <strong>Dockside Experiences</strong></span> <br />
<span className="rounded px-2 py-1 inline-block">✅ <strong>Hassle-Free Getaways</strong></span><br />
<br />
